...
DataHub ingests dashboards, charts, explores, and LookML views from Looker. It can also capture lineage to warehouse tables, usage statistics, ownership from Looker users, and folder hierarchy as containers.
